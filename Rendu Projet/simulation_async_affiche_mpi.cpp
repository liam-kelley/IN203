...
void simulation(bool affiche, auto *adressArgc, auto *adressArgv)
{
    ...
    {   
        ...
        if (rank >= 1)
        {
            ...
            /* Anciennement d'abord MPI_Iprobe
            puis un if(probeflag==true)
            {
                do recv and send
            }
            else
            SKIP une journée pour accélerer!

            mais cela à amené des problèmes de décalages temporels et de pertes de données intermédiaires...
            Cette version est plus lente mais préférable.
            */
